...
alias vid='mpv'
alias yay='paru'
alias qalc='qalc --color --interactive -set "fractions off"'
alias calc='qalc --exrates --color --interactive -set "fractions off"'
alias gccc='x86_64-elf-gcc'
alias ldc='x86_64-elf-ld'
...
alias acp="git add . && git commit -s -m 'wip: automated dev-commit' && git push"
